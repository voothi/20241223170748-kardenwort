...
set "LEMMA_INDEX_FILE=%CFG_kardenwort_workspace%/data/en-news-2023-1m-words.csv"
set "LEMMA_OVERRIDE_FILE=%CFG_kardenwort_workspace%/data/lemma_override_en.tsv"
