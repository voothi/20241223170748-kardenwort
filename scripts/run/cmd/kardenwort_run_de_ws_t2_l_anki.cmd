...
call "%PYTHON_EXE%" "%KARDENWORT_RUNNER_SCRIPT%" --language de --type word --mode dual --de-gcs --de-gcs-pos-tags "!VERB"
if errorlevel 1 goto :error

echo.
echo Dual sentence mode...
call "%PYTHON_EXE%" "%KARDENWORT_RUNNER_SCRIPT%" --language de --type sentence --mode dual
if errorlevel 1 goto :error
