        ...
        with open(output_file, "w", newline='', encoding='utf-8') as tsvfile:
            ...
            for token in final_sorted_tokens:
                ...
                if two_column_output_to_file:
                    tsv_writer.writerow([token, original_form, "", "", left_context, sentence, right_context, "", simple_list_entry, sentence, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "1", "", "", "", "", "", "", "1"])
                else:
                    tsv_writer.writerow([token,            "", "", "", left_context, sentence, right_context, "", simple_list_entry, sentence, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "1", "", "", "", "", "", "", "1"])
